            ...
            <div class="ui form changeAccountInfo" style="max-width: 600px;">
                <div class="field">
                    <div class="ui left icon input">
                        <i class="icon user"></i>
                        <input placeholder="Numele tau" type="text" name="name" value="<?php echo e(Auth::user()->nume); ?>">
                    </div>
                </div>
                <div class="field">
                    <div class="ui left icon disabled input">
                        <i class="icon mail"></i>
                        <input placeholder="Email" type="text" name="email" value="<?php echo e(Auth::user()->email); ?>"><br />
                    </div>
                ...
                <div class="field">
                    <div class="ui left icon input">
                        ...
                        <input placeholder="Adresa" type="text" name="address" value="<?php echo e(Auth::user()->adresa); ?>">
                    </div>
                </div>
                <div class="field">
                    <div class="ui left icon input">
                        <i class="icon phone"></i>
                        <input placeholder="Numar de telefon" type="text" name="phone" value="<?php echo e(Auth::user()->telefon); ?>">
                    </div>
                </div>
                <div class="field">
                    <div class="ui left icon input">
